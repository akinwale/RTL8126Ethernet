...
u32 mdio_real_direct_read_phy_ocp(struct rtl8126_private *tp,
                                         u16 RegAddr)
{
    u32 data32;
    int i, value = 0;
...
void ClearAndSetEthPhyOcpBit(struct rtl8126_private *tp, u16 addr, u16 clearmask, u16 setmask)
{
    ...
    PhyRegValue = mdio_real_direct_read_phy_ocp(tp, addr);
    PhyRegValue &= ~clearmask;
    PhyRegValue |= setmask;
    mdio_real_direct_write_phy_ocp(tp, addr, PhyRegValue);
}
