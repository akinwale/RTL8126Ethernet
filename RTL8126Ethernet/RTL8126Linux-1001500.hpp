//
//  RTL8126Linux-1001500.hpp
//  RTL8126Ethernet
//
//  Created by Akinwale Ariwodola on 04/04/2025.
//  Copyright © 2025 Akinwale Ariwodola. All rights reserved.
//

#ifndef RTL8126Linux_1001500_h
#define RTL8126Linux_1001500_h
...
void rtl8126_rar_set(struct rtl8126_private *tp, const u8 *addr);
void rtl8126_hw_init(struct net_device *dev);
void rtl8126_powerup_pll(struct net_device *dev);
u32 rtl8126_get_hw_wol(struct rtl8126_private *tp);
void rtl8126_disable_rxdvgate(struct net_device *dev);
void rtl8126_hw_ephy_config(struct net_device *dev);
void rtl8126_enable_force_clkreq(struct rtl8126_private *tp, bool enable);
void rtl8126_enable_aspm_clkreq_lock(struct rtl8126_private *tp, bool enable);
void rtl8126_set_eee_lpi_timer(struct rtl8126_private *tp);
...
void rtl8126_set_tx_q_num(struct rtl8126_private *tp, unsigned int num_tx_queues);
void rtl8126_tally_counter_addr_fill(struct rtl8126_private *tp);
void rtl8126_enable_extend_tally_couter(struct rtl8126_private *tp);
void rtl8126_desc_addr_fill(struct rtl8126_private *tp);
void rtl8126_disable_l1_timeout(struct rtl8126_private *tp);
void rtl8126_clear_tcam_entries(struct rtl8126_private *tp);
void rtl8126_hw_set_interrupt_type(struct rtl8126_private *tp, u8 isr_ver);
void rtl8126_hw_clear_timer_int(struct net_device *dev);
void rtl8126_hw_clear_int_miti(struct net_device *dev);
u8 rtl8126_get_l1off_cap_bits(struct rtl8126_private *tp);
...
void rtl8126_disable_extend_tally_couter(struct rtl8126_private *tp);
void rtl8126_enable_d0_speedup(struct rtl8126_private *tp);
void rtl8126_enable_phy_aldps(struct rtl8126_private *tp);
void rtl8126_set_hw_wol(struct net_device *dev, u32 wolopts);
bool rtl8126_keep_wol_link_speed(struct net_device *dev, u8 from_suspend);
void rtl8126_set_wol_link_speed(struct net_device *dev);
void rtl8126_phy_power_down(struct net_device *dev);
void rtl8126_init_hw_phy_mcu(struct net_device *dev);
u32 mdio_real_direct_read_phy_ocp(struct rtl8126_private *tp, u16 RegAddr);
