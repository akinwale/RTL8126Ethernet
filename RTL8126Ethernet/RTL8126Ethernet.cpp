/* RTL8126Ethernet.cpp -- RTL8126 driver class implementation.
*
...
*
* This driver is based on Realtek's rtl8126 Linux driver (10.015.00).
*/
...
OSDefineMetaClassAndStructors(RTL8126, super)
...
IOReturn RTL8126::registerWithPolicyMaker(IOService *policyMaker)
{
...
IOReturn RTL8126::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker)
{
...
void RTL8126::systemWillShutdown(IOOptionBits specifier)
{
...
IOReturn RTL8126::enable(IONetworkInterface *netif)
{
...
IOReturn RTL8126::disable(IONetworkInterface *netif)
{
    UInt64 timeout;
    UInt64 delay;
    UInt64 now;
        ...
        if (offloadFlags & (MBUF_TSO_IPV4 | MBUF_TSO_IPV6)) {
            if (offloadFlags & MBUF_TSO_IPV4) {
                if ((len - kMacHdrLen) > mtu) {
                    ...
                    opts2 = ((mss & MSSMask) << MSSShift_8126);
                } else {
                    /*
...
void RTL8126::getPacketBufferConstraints(IOPacketBufferConstraints *constraints) const
{
...
IOOutputQueue* RTL8126::createOutputQueue()
{
...
const OSString* RTL8126::newVendorString() const
{
...
const OSString* RTL8126::newModelString() const
{
...
bool RTL8126::configureInterface(IONetworkInterface *interface)
{
...
IOWorkLoop* RTL8126::getWorkLoop() const
{
...
IOReturn RTL8126::getHardwareAddress(IOEthernetAddress *addr)
{
    IOReturn result = kIOReturnError;
...
IOReturn RTL8126::setPromiscuousMode(bool active)
{
...
IOReturn RTL8126::setMulticastMode(bool active)
{
    UInt32 *filterAddr = (UInt32 *)&multicastFilter;
    UInt32 mcFilter[2];
    UInt32 rxMode;
...
IOReturn RTL8126::setMulticastList(IOEthernetAddress *addrs, UInt32 count)
{
    UInt32 *filterAddr = (UInt32 *)&multicastFilter;
    UInt64 filter = 0;
    UInt32 i, bitNumber;
...
IOReturn RTL8126::getChecksumSupport(UInt32 *checksumMask, UInt32 checksumFamily, bool isOutput)
{
...
UInt32 RTL8126::getFeatures() const
{
...
IOReturn RTL8126::setWakeOnMagicPacket(bool active)
{
    IOReturn result = kIOReturnUnsupported;
...
IOReturn RTL8126::getPacketFilters(const OSSymbol *group, UInt32 *filters) const
{
...
IOReturn RTL8126::setHardwareAddress(const IOEthernetAddress *addr)
{
    IOReturn result = kIOReturnError;
...
IOReturn RTL8126::selectMedium(const IONetworkMedium *medium)
{
    IOReturn result = kIOReturnSuccess;
...
IOReturn RTL8126::getMaxPacketSize(UInt32 * maxSize) const
{
...
IOReturn RTL8126::setMaxPacketSize(UInt32 maxSize)
{
...
void RTL8126::pciErrorInterrupt()
{
